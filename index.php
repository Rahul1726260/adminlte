...
<?php
  ...
  if(isset($_POST['submitadd']))
  {
    ...
    $spentbudget=$_POST['spentbudget'];
    $estimatedduration=$_POST['estimatedduration'];
    $sql = "INSERT INTO `project` (`project_name`, `project_desc`,`project_team`,`project_status`, `client_company`, `project_leader`, `project_added`) 
    VALUES ('$projectname', '$projectdesc','$team','$projectstatus', '$clientcompany', '$projectleader', CURRENT_TIMESTAMP)";
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">Project Operation</li>
          <li class="nav-item">
